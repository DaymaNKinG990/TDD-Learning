...
- **[Настройка окружения](02_environment_setup.md)** - настройка CI/CD окружения
- **[Инструменты и фреймворки](13_tools_frameworks.md)** - инструменты для CI/CD
- **[Интеграционное тестирование](09_integration_testing.md)** - тесты в CI/CD
- **[TDD в веб-разработке](10_web_development_tdd.md)** - деплой веб-приложений
- **[Метрики покрытия кода](16_code_coverage_metrics.md)** - метрики в CI/CD
- **[Тестирование обработки ошибок](15_error_handling_tdd.md)** - обработка ошибок в CI/CD
