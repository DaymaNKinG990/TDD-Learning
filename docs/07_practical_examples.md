...
!!! note "Предварительные знания"
    Перед изучением этой главы рекомендуется освоить:
    - [Цикл Red-Green-Refactor](03_red_green_refactor.md)
    - [Основы тестирования в Python](04_python_testing_basics.md)
    - [Pytest фреймворк](06_pytest.md)
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": [
        ...
        {"text": "Создание → Депозит → Снятие → Валидация → Перевод", "correct": true},
