...
- **[Основы TDD](01_tdd_basics.md)** - TDD как инструмент проектирования
- **[Продвинутые техники](11_advanced_tdd.md)** - архитектурные тесты
- **[TDD в веб-разработке](10_web_development_tdd.md)** - архитектура веб-приложений
- **[Стратегии работы с Legacy Code](17_legacy_code_strategies.md)** - рефакторинг архитектуры
- **[Продвинутое мокирование](18_advanced_mocking.md)** - мокирование и архитектура
- **[Лучшие практики](12_best_practices.md)** - архитектурные практики
