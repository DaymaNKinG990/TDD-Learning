...
- **[Pytest фреймворк](06_pytest.md)** - использование моков с pytest
- **[Практические примеры](07_practical_examples.md)** - применение моков в реальных проектах
- **[Интеграционное тестирование](09_integration_testing.md)** - когда моки не нужны
- **[Продвинутое мокирование](18_advanced_mocking.md)** - сложные сценарии мокирования
- **[TDD в веб-разработке](10_web_development_tdd.md)** - мокирование в веб-приложениях
- **[Лучшие практики](12_best_practices.md)** - антипаттерны мокирования
